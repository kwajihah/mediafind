...
<head>
    ...
    <style>
        ...
        /* Butang GO TO MEDIAFIND SYSTEM (gradient biru-purple) */
        .btn-mediafind { display: inline-block; padding: 14px 30px; text-decoration: none; border-radius: 8px; font-weight: bold; background: linear-gradient(135deg, #00d2ff, #7b2ff7); color: white; transition: 0.3s; margin-top: 40px; margin-left: 15px; font-size: 1.1rem; }
        .btn-mediafind:hover { opacity: 0.85; transform: translateY(-2px); box-shadow: 0 5px 20px rgba(123, 47, 247, 0.4); }
    </style>
</head>
<body>
...
<a href="mediafind/index.php" class="btn-mediafind">GO TO MEDIAFIND SYSTEM</a>
